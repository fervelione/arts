...
/* harmony import */ var _modules_changePicture__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/changePicture */ "./src/js/modules/changePicture.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_calculate__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.promocode', '.calc-price');
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_modules_changePicture__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
...
var accordion = function accordion(btnSelector) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calculate = function calculate(sizeSel, materialSel, optionalSel, promocodeSel, sumSel) {
  var size = document.querySelector(sizeSel),
  ...
  function result() {
    var result = Math.round(+size.value * +material.value + +option.value);
...
var changePicture = function changePicture(imgSelector) {
  var imgBlocks = document.querySelectorAll(imgSelector);

  function showImg(img) {
    var imgs = img.querySelector('img'); // something.png => something-1.png

    imgs.src = imgs.src.slice(0, -4) + '-1.png';
    img.querySelectorAll('p:not(.sizes-hit)').forEach(function (p) {
  ...
  imgBlocks.forEach(function (img) {
...
var drop = function drop() {
  ...
  var fileInputs = document.querySelectorAll('[name="upload"]')[('dragenter', 'dragleave', 'dragover', 'drop')].forEach(function (eventName) {
...
var modals = function modals() {
  ...
  function modal(buttonSelector, modalSelector, closeSelector) {
  ...
  function calcScroll() {
    ...
    var calc = div.offsetWidth - div.clientWidth;
    div.remove();
    return calc;
  }
...
var showMoreCards = function showMoreCards(btnSelector, cardsSelector) {
...
var sliders = function sliders(slidersSelector, direction, prevSelector, nextSelector) {
  var sliders = document.querySelectorAll(slidersSelector);
  var slideIndex = 0;
  var paused = false;
  ...
  activateAnimation();
  sliders[0].parentNode.addEventListener('mouseenter', function () {
    clearInterval(paused);
  });
  sliders[0].parentNode.addEventListener('mouseleave', function () {
    activateAnimation();
  });
};
